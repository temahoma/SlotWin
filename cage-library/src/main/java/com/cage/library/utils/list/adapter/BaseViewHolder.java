...
import com.cage.library.utils.view.TextViewUtils;
...
public class BaseViewHolder extends ViewHolder implements OnClickListener{
    ...
    public BaseViewHolder setImageT(ImageView view, String imageUrl) {
//        ImageUtil.setImageT(view, imageUrl);
        return this;
    }
