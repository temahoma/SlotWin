package com.cage.library.infrastructure.text;
...
public class StringUtils {
    ...
    public static String concat(@StringRes int stringId, String text) {
        return ResourceHelper.getString(stringId) + text;
    }
    ...
    public static boolean isTrue(String str) {
        return !isEmpty(str) && (str.equals("1") || str.equals("true"));
    }
}
